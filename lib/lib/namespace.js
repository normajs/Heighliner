            ...
            return Meteor.startup(function () {
                ...
                query.observeChanges({
                    changed: function (id, fields) {
                        ...
                        if ((fields != null ? (ref = fields.workers) != null ? ref.length : void 0 : void 0) === self.cluster.count()) {
...
/*
       ...
       */
        ...
        _heighliner.prototype.process = function (cb) {
            var self;
            self = this;
            if (self.isMaster) {
                return;
            }
            return self.manifestActions.push(cb);
        };
